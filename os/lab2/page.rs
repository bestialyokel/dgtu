...
fn main() {
    ...
    fn LRUswap(ram: &mut [usize], hdd: &mut [usize], x: usize) {
        ...
        let page_info_ptr =
            ram[page * PAGE_INFO_SIZE..].as_mut_ptr() as *mut [usize; PAGE_INFO_SIZE];
    ...
    fn write(ram: &mut [usize], hdd: &mut [usize], x: usize, data: &[usize], start: Instant) {
        ...
        ram[x * PAGE_INFO_SIZE + PAGE_TIMESTAMP] =
            now.duration_since(start).subsec_millis() as usize;
