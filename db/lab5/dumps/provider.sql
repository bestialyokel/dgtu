...
8	abc	abcab	aca	ba
7	aberbe	dabad	aeqw	89613308963
9	a	b	cd	e
\.
...
COPY public.jobs (idjob, idappeal, descr, status) FROM stdin;
\.
...
44	4	85aedf3dbe222989caa236be76b0d90f	d
\.
...
3	\N	danilka22	bachurin	dmitriech	abc
2	\N	danuk	11wer1	mont1	tst
\.
...
SELECT pg_catalog.setval('public.appeals_idappeal_seq', 11, true);
...
SELECT pg_catalog.setval('public.clients_idclient_seq', 9, true);
...
SELECT pg_catalog.setval('public.contracts_idcontract_seq', 8, true);
...
SELECT pg_catalog.setval('public.jobs_idjob_seq', 6, true);
...
SELECT pg_catalog.setval('public.logins_idlogin_seq', 44, true);
...
SELECT pg_catalog.setval('public.services_idservice_seq', 6, true);
...
SELECT pg_catalog.setval('public.tariffs_idtariff_seq', 4, true);
...
SELECT pg_catalog.setval('public.workers_idworker_seq', 29, true);
