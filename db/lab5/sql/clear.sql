...
DROP PROCEDURE IF EXISTS ROLLBACK_SERVICE;
DROP PROCEDURE IF EXISTS ROLLBACK_TARIFF;
DROP PROCEDURE IF EXISTS ROLLBACK_CLIENT;
DROP PROCEDURE IF EXISTS ROLLBACK_CONTRACT;