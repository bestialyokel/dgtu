...
DROP FUNCTION IF EXISTS ROLLBACK_SERVICE;
DROP FUNCTION IF EXISTS ROLLBACK_TARIFF;
DROP FUNCTION IF EXISTS ROLLBACK_CLIENT;
DROP FUNCTION IF EXISTS ROLLBACK_CONTRACT;
DROP FUNCTION IF EXISTS ROLLBACK_APPEAL;
DROP FUNCTION IF EXISTS ROLLBACK_JOB;
DROP FUNCTION IF EXISTS ROLLBACK_WORKER;
