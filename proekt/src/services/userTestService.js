            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result == null)
                            throw new errors_1.ResourceNotFoundError("user " + id + " not found");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result == null)
                            throw new errors_1.ResourceNotFoundError("login/token/yahz " + key + " not found");
                        return [2 /*return*/, result];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result == null)
                            throw new errors_1.ResourceNotFoundError("login/token/yahz " + id + " not found");
                        return [2 /*return*/, result];
                }
            });
        });
